      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-4 mb-lg-0">
          <nav class="nav nav-masthead justify-content-center float-md-end">
            <a class="nav-link fw-bold py-1 px-0 m-4 " aria-current="page" href="index2.php">Home</a>
            <a class="nav-link fw-bold py-1 px-0 m-4" href="home2.php">Brand</a>
  ...
  <div class="container">
    <footer class="py-3 my-4">
      <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        <li class="nav-item"><a href="home2.php" class="nav-link px-2 text-body-secondary">Home</a></li>
        <li class="nav-item"><a href="home2.php?pt=1" class="nav-link px-2 text-body-secondary">Adidas</a></li>
        <li class="nav-item"><a href="home2.php?pt=2" class="nav-link px-2 text-body-secondary">Nike</a></li>
        <li class="nav-item"><a href="home2.php?pt=3" class="nav-link px-2 text-body-secondary">Chompion</a></li>
