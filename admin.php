            ...
            <div class="container">
                <table border="1">
                    <tr>
                        ...
                        <td width=7%>รหัสผู้ดูแลระบบ</td>
                        <td width=15%>ชื่อผู้ดูแลระบบ</td>
                        <td width=20%>อีเมล</td>
                        <td width=10%>รหัสผ่าน</td>
                        <td width=10%>เบอร์โทรศัพท์</td>
                        <td width=10%>แก้ไขข้อมูล</td>
                    ...
                    $sql = "SELECT * FROM `admin` WHERE (`a_id` LIKE '%{$kw}%' OR `a_fullname` LIKE '%{$kw}%')"; //sql การค้นหาข้อมูลโดยดึงจากฐานข้อมูล
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <center><?= $data['a_fullname']; ?></center>
                            </td>
                            <td>
                                <center><?= $data['a_email']; ?></center>
                            </td>
                            <td>
                                <center><?= $data['a_password']; ?></center>
                            </td>
                            <td>
                                <center><?= $data['a_tel']; ?></center>
                            </td>
                            <td><a href="up2.php?id=<?= $data['a_id']; ?>"><img src="images/edit2.jpg" width="30"></a></td>
                            <td><a href="de2.php?id=<?= $data['a_id']; ?>&ext"><img src="images/trash.jpg" width="30" onClick="return confirm('ยืนยันการลบสมาชิก?');"></a></td>
                        </tr>
                        <?php
                        ?>
                    <?php }
