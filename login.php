        ...
        <div class="col-md-6 col-lg-4 py-3">
            <div class="login-wrap py-5 card-body text-center">
                ...
                <div class="w-100 text-center mt-4 text">
                    <p class="mb-0">หากคุณยังไม่มีบัญชีผู้ใช้ คลิกที่นี้</p>
...
if(isset($_POST['Submit'])){ //มีการกำหนดค่าให้ปุ่ม submit  ชื่อของปุ่มต้องตรงกัน
    ...
    $sql = "SELECT * FROM `users` WHERE `u_email`='{$_POST['usr']}' AND `u_password`='".md5($_POST['pwd'])."' LIMIT 1 ";  
    ...
    if($num>0){
        ...
        $_SESSION['uname'] = $data['u_fullname'];
        echo "<script>";
